...
slvmessgrpclink="vmess://${uuid}@${domain}:4369/?type=grpc&encryption=auto&serviceName=DrgTech&security=xtls&flow=${muncrat}&sni=${domain}#$user"
slvlessgrpclink="vless://${uuid}@${domain}:4369/?mode=gun&security=xtls&encryption=none&type=grpc&serviceName=DrgTech&flow=${muncrat}&sni=${domain}#$user"
slvlesswslink="vless://${uuid}@${domain}:7869/?path=/DrgTech&security=xtls&encryption=none&sni=${domain}&flow=${muncrat}&type=ws#${user}"
slvmesswslink="vmess://${uuid}@${domain}:7869/?path=/DrgTech&security=xtls&encryption=none&sni=${domain}&flow=${muncrat}&type=ws#${user}"
...
echo -e "Script Create Auto Account by Ridwan "
echo -e "================================="
echo -e "Remarks              : ${user}"
...
echo -e "Service Name gRPC    : DrgTech"
echo -e "================================="
